...
// Arrow function for the function above

let newSum = (a,b,c,d) => `${a} + ${b} + ${c} +${d} = ${a + b + c + d}`;
console.log ('This is done using the new arrow function. ' + 'The sum is' + newSum(2,3,4,5));
...
let sumAndProduct = function(a, b) {let sum = a + b; let product = a * b; return [sum, product]};

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(sumAndProduct(3, 9));

// Arrow function for the function above
let newSumAndPro = (aa, bb) => {
  let newSum = aa + bb;
  let newPro = aa * bb;
  return [newSum, newPro];
}
console.log(newSumAndPro(3,9));
...
// Arrow function for the function above
let newMessage = (newName) => `Hello, ${newName}`;
console.log(newMessage('Alice lost in Wonderland'));
